...
const TargetBiology = () => {
	...
	const { data: targetDetailsData, error: targetDetailsError, isLoading:targetDetailsLoading } = useQuery(
	...
	return (
		<div>
			<AboutTarget
				...
				targetDetailsLoading={targetDetailsLoading}
			...
			/>
			<ProteinExpressions target={target} indications={indications} />
			...
			<SubCellularLocation target={target} indications={indications} />
		</div>
	);
};
