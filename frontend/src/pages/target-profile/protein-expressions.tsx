...
const ProteinExpressions = ({ target, indications }) => {
	...
	return (
		<section id='protein-expression' className='mt-12 px-[5vw] bg-gray-50 py-20'>
			...
			<p className='mt-2 italic font-medium'>
				Baseline RNA and protein expression data helps us to ascertain whether
				the target is expressed in all tissues or selectively in one or few
				tissues or cell types. The availability of the target molecule in the
				location of interest is critical at different stages of the drug
				development process.
			</p>
			...
			{!targetProteinExpressioLoading && !targetProteinExpressionError && !targetProteinExpressionData && <Empty description="No data available" />}
			{
